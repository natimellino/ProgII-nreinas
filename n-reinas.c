...
// Leer el archivo 'ReadMe.txt' con toda la información acerca del código. 
...
// En la función 'main' pedimos el ingreso del nombre del archivo, leemos los datos y ubicamos las n reinas 
